        ...
        children: <Widget>[
          ...
          Expanded(
            child: ListView(
              ...
              children: <Widget>[
                Text('方向与锚点', style: Theme.of(context).textTheme.titleMedium),
                const SizedBox(height: 8),
                ...
                SegmentedButton<ParametricBubbleAnchor>(
                  ...
                  onSelectionChanged:
                      (selected) =>
                          _update(_config.copyWith(anchor: selected.first)),
                ),
                const SizedBox(height: 16),
                Text('几何参数', style: Theme.of(context).textTheme.titleMedium),
                _SliderSetting(
                  label: '垂直偏移 offset',
                ...
                _SliderSetting(
                  ...
                  unit: 'px',
                  onChanged:
                      (value) => _update(_config.copyWith(tailLength: value)),
                ),
                _SliderSetting(
                ...
                _SliderSetting(
                  ...
                  unit: '',
                  onChanged:
                      (value) => _update(_config.copyWith(sharpness: value)),
                ),
                _SliderSetting(
                  label: '主体圆角 radius',
                ...
                const SizedBox(height: 16),
                Text('样式颜色', style: Theme.of(context).textTheme.titleMedium),
