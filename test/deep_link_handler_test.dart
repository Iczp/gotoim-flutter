...
void main() {
  ...
  group('DeepLinkHandler Authentication & Pending Links', () {
    test(
      'queues protected link to PendingDeepLink when unauthenticated',
      () async {
        final handler = DeepLinkHandler(isAuthenticatedProvider: () => false);
  ...
  group('DeepLinkHandler Unimplemented Route Handling', () {
    test('returns notImplemented for ChatDeepLink without crashing', () async {
      final handler = DeepLinkHandler(isAuthenticatedProvider: () => true);
    ...
    test(
      'returns notImplemented for GroupInviteDeepLink with security note',
      () async {
        final handler = DeepLinkHandler(isAuthenticatedProvider: () => true);
